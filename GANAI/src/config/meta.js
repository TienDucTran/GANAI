...
const metaConfig = {
    ...
    spaces: {
        title: 'Our Spaces | Miumiu Design Studio',
        description:
    ...
    spaceDetail: {
        title: 'Space Details | Miumiu Design Studio',
        description:
    ...
    exhibitions: {
        title: 'Exhibitions | Miumiu Design Studio',
        description:
    ...
    products: {
        title: 'Products & Services | Miumiu Design Studio',
        description:
    ...
    introduce: {
        title: 'About Us | Miumiu Design Studio',
        description:
    ...
    contact: {
        title: 'Contact Us | Miumiu Design Studio',
        description:
